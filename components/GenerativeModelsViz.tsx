        ...
        <div className="h-[400px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 10, right: 10, bottom: 10, left: 0 }}>
              ...
              <Area type="monotone" name="Class 1: p(x | C1)" dataKey="p1" stroke="var(--chart-primary)" fill="var(--chart-primary)" fillOpacity={0.3} />
              <Area type="monotone" name="Class 2: p(x | C2)" dataKey="p2" stroke="var(--chart-success)" fill="var(--chart-success)" fillOpacity={0.3} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </ChartCard>
