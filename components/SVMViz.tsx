        ...
        <div className="h-[400px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart margin={{ top: 20, right: 30, bottom: 20, left: 10 }}>
              ...
              <Line data={decisionBoundary} type="linear" dataKey="y" stroke="#ff4d4f" strokeWidth={3} dot={false} />
              <Line data={marginUpper} type="linear" dataKey="y" stroke="#ff4d4f" strokeWidth={1} strokeDasharray="5 5" dot={false} />
              <Line data={marginLower} type="linear" dataKey="y" stroke="#ff4d4f" strokeWidth={1} strokeDasharray="5 5" dot={false} />
            </ScatterChart>
          </ResponsiveContainer>
        </div>
      </ChartCard>
