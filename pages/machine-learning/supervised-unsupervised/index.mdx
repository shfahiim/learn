...
In Supervised Learning, models are trained on **labeled data**. This means for every input example $\mathbf{x}_i$, the algorithm is also given a "ground truth" target label $y_i$.
