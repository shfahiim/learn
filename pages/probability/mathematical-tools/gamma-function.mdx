...
Why is there a weird $\Gamma$ symbol in the [Gamma and Beta](./gamma-beta) distributions? It's not just a constant—it is one of the most important functions in mathematical analysis.
</Callout>
...
*   Define the [Student's T-Distribution](./students-t) and [Chi-Square Distribution](./chi-square).
*   Model time until $k$ events in a Poisson process.
*   Calculate high-dimensional volumes (crucial for [Joint Distributions](./joint-distributions)).
