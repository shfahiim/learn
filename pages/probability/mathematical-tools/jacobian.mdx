...
When we move to [Joint Distributions](../multivariate/fundamentals) (e.g., $(X, Y) \to (U, V)$), we don't just use a single derivative. We use a **Jacobian Matrix** of partial derivatives, and we take its **Determinant**. 
