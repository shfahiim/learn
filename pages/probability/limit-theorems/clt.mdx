...
### Why Does It Work? (The "God-Tier" Intuition)

The rigorous proof of the CLT uses **[Moment Generating Functions (MGFs)](../mathematical-tools/moments)**. 

When you add independent random variables together, you multiply their MGFs. As you multiply more and more MGFs, the result mathematically "shrinks" towards a specific mathematical form: the MGF of a Normal distribution. In other words, the Normal distribution is the unique "attractor" in the world of probability.
